        ...
        <div>
            ...
            <div className="container_central flex flex-col items-center justify-center gap-18pt-20 overflow-y-hidden">
                ...
                <div className=" flex pt-0 gap-10 ">
                    <div className="flex z-10 hover:bg-gradient-to-r from-green-300 to-blue-200 items-center mt-40 bg-blue-950 gap-3 text-xl font-bold w-64 py-2 rounded-lg mb-20  text-blue-400 ">
                        <div>
                    ...
                    <div className="flex z-10 hover:bg-gradient-to-r from-green-400 to-blue-400 items-center mt-40 bg-blue-400 gap-3 text-xl font-bold w-64 py-2 rounded-lg mb-20  text-blue-950 ">
                        <div>
